...
# ╔═╡ 0f80e14d-9fdc-4012-8f21-fad5db22d7bb
using Plots
...
function RecQ(a,b,f,quadR,relerr,lvl,points)
	MaxLevel = 6
	Qab = quadR(a,b,f,points)
	c = a + 0.5*(b-a)
	Qac = quadR(a,c,f,points); Qcb = quadR(c,b,f,points)
	Qacb = Qac + Qcb
	if (abs(Qab-Qacb) <= relerr*abs(Qacb) || (lvl >= MaxLevel))
		return Qacb
	else
		return RecQ(a,c,f,quadR,relerr,lvl+1,points) + RecQ(c,b,f,quadR,relerr,lvl+1,points)
...
# ╔═╡ 88238549-350f-49ce-8d75-189838651e01
points0 = []

# ╔═╡ f2106196-1b88-40f5-b58a-18e73e27426a
RecQ(0,1,f2,trapezoid,0.001,0,points0)

# ╔═╡ d3dbaf2f-642c-4757-ae4e-8ae0ab87f9d0
f3(x) = sin(exp(x))

# ╔═╡ 4b24f2a7-ce4d-4ccd-ba2e-c2af5bfaf623
RecQ(0,4,f3,trapezoid,0.001,0,points0)
...
desiredplot(0,1,f2,trapezoid,0.001,0,RecQ,"x^2 trapezoid adaptive quadrature")
